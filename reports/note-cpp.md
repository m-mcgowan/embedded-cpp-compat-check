...
|----------|-------------|----------|
| avr-uno | — | 0/11 |
| esp32s3-arduino-v3 | — | 3/11 |
| rp2040-pico | — | 0/11 |
| stm32-nucleo-f411re | — | 3/11 |
...
| arduino/serial_basic | FAIL | FAIL | FAIL | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL | FAIL | FAIL | FAIL | PASS | PASS | PASS | PASS |
| attention_pin | FAIL | FAIL | FAIL | PASS | PASS | PASS | PASS | PASS | PASS | FAIL | FAIL | FAIL | FAIL | FAIL | PASS | PASS | PASS | PASS |
...
| location_tracking | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| migration_notec | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| sending-notes | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| smoke | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| target_filtering | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
| zero_alloc | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL | FAIL |
...
### rp2040-pico c++23: migration_notec
```
lib/note-cpp/include/note/allocator.hpp:60:37: error: 'std::pmr' has not been declared
```
...
### stm32-nucleo-f411re c++20: location_tracking
```
src/getting_started.cpp:27:10: fatal error: mock_backend.hpp: No such file or directory
```
...
### stm32-nucleo-f411re c++20: smoke
```
src/migration_notec.cpp:84:5: error: 'int16_t' does not name a type
```
...
### stm32-nucleo-f411re c++20: zero_alloc
```
src/migration_notec.cpp:84:5: error: 'int16_t' does not name a type
```
