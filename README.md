...
- **[Browsable HTML site](https://m-mcgowan.github.io/embedded-cpp-compat-check/)** — per-feature results with cppreference links and expandable compiler errors
...
"Effective support" is the percentage of features that compile successfully, regardless of whether the SD-6 feature-test macro is defined. The standard shown is the one at which the peak percentage was reached. 🟢 ≥90% · 🟡 50–89% · 🔴 <50%.
