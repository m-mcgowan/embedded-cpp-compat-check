...
|----------|-------|-----------|-------------------|-----------|
| [ESP32-S3 (pioarduino)](https://m-mcgowan.github.io/embedded-cpp-compat-check/esp32s3-arduino-v3/index.html) | esp32s3 | C++11–C++26 | **C++17 / 100%** | **C++20: 5✅ 3🟡** · C++23: 1✅ 5❌ |
| [ESP32-S3 (espressif32 official)](https://m-mcgowan.github.io/embedded-cpp-compat-check/esp32s3-espressif32/index.html) | esp32s3 | C++11–C++26 | **C++17 / 100%** | **C++20: 5✅ 3🟡** · C++23: 1✅ 5❌ |
| [Raspberry Pi Pico (RP2040)](https://m-mcgowan.github.io/embedded-cpp-compat-check/rp2040-pico/index.html) | RP2040 Cortex-M0+ | C++11–C++23 | **C++14 / 97%** | **C++17: 3✅ 5❌** · C++20: 1✅ 7❌ |
| [Raspberry Pi Pico (RP2040) +polyfill](https://m-mcgowan.github.io/embedded-cpp-compat-check/rp2040-pico+recipe/index.html) | RP2040 Cortex-M0+ | C++11–C++23 | **C++23 / 45%** | **C++17: 3✅ 5❌** · C++20: 1✅ 7❌ |
| [SAMD51 Adafruit Feather M4](https://m-mcgowan.github.io/embedded-cpp-compat-check/samd51-feather-m4/index.html) | SAMD51 Cortex-M4F | C++11–C++17 | **C++14 / 97%** | **C++17: 3✅ 5❌** |
| [STM32 Nucleo F411RE](https://m-mcgowan.github.io/embedded-cpp-compat-check/stm32-nucleo-f411re/index.html) | STM32F411 Cortex-M4 | C++11–C++20 | **C++14 / 97%** | **C++17: 5✅ 3🟡** · C++20: 1✅ 7❌ |
| [Teensy 4.1](https://m-mcgowan.github.io/embedded-cpp-compat-check/teensy41/index.html) | i.MX RT1062 Cortex-M7 | C++11–C++20 | **C++14 / 97%** | **C++17: 5✅ 3🟡** · C++20: 1✅ 7❌ |
| [nRF52840 Arduino Nano 33 BLE](https://m-mcgowan.github.io/embedded-cpp-compat-check/nrf52840-nano33ble/index.html) | nRF52840 Cortex-M4F | C++11–C++20 | **C++11 / 95%** | **C++17: 3✅ 5❌** · C++20: 8❌ |
| [SAMD21 Arduino Zero](https://m-mcgowan.github.io/embedded-cpp-compat-check/samd21-zero/index.html) | SAMD21 Cortex-M0+ | C++11–C++17 | **C++11 / 95%** | **C++17: 3✅ 5❌** |
| [Arduino Uno R4 Minima](https://m-mcgowan.github.io/embedded-cpp-compat-check/uno-r4-minima/index.html) | Renesas RA4M1 | C++11–C++20 | **C++11 / 95%** | **C++17: 3✅ 5❌** · C++20: 8❌ |
| [ESP8266 NodeMCU](https://m-mcgowan.github.io/embedded-cpp-compat-check/esp8266-nodemcu/index.html) | ESP8266 Xtensa LX106 | C++17 | **C++17 / 94%** | **C++17: 5✅ 3🟡** |
| [AVR Arduino Uno](https://m-mcgowan.github.io/embedded-cpp-compat-check/avr-uno/index.html) | ATmega328P | C++11–C++17 | **C++11 / 86%** | **C++17: 3✅ 5❌** |
| [AVR Arduino Uno +polyfill](https://m-mcgowan.github.io/embedded-cpp-compat-check/avr-uno+recipe/index.html) | ATmega328P | C++11–C++17 | **C++17 / 41%** | **C++17: 3✅ 5❌** |
| [megaAVR Arduino Nano Every](https://m-mcgowan.github.io/embedded-cpp-compat-check/megaavr-nano-every/index.html) | ATmega4809 | C++11–C++17 | **C++11 / 86%** | **C++17: 3✅ 5❌** |
| [megaAVR Arduino Nano Every +polyfill](https://m-mcgowan.github.io/embedded-cpp-compat-check/megaavr-nano-every+recipe/index.html) | ATmega4809 | C++11–C++17 | **C++17 / 41%** | **C++17: 3✅ 5❌** |
<!-- compat-matrix-end -->
...
Rows labeled `+polyfill` show results after adding a polyfill library to `platformio.ini`. Two polyfills cover all supported platforms:

- **[nonstd-lite-bundle](https://github.com/m-mcgowan/nonstd-lite-bundle)** — shims for `<optional>`, `<string_view>`, `<variant>`, `<span>`, `<expected>`, `<any>`. Used on ARM, ESP32, RP2040, Teensy, and ESP8266. See its README for installation and usage details.
- **[avr-libstdcpp](https://github.com/m-mcgowan/avr-libstdcpp)** — C++ standard library backport for AVR. Used on `avr-uno` and `megaavr-nano-every`. AVR platforms need this *instead of* nonstd-lite-bundle; the latter can't function on AVR without a base stdlib to build on.

To reproduce a `+polyfill` row in your own project, add the matching library to `lib_deps`:

```ini
# AVR (Arduino Uno, Nano Every)
lib_deps = https://github.com/m-mcgowan/avr-libstdcpp.git#add-library-json

# ARM / ESP32 / RP2040 / Teensy / ESP8266
lib_deps = nonstd-lite-bundle
```

The per-platform polyfill mapping is defined under `recipe.lib_deps` in `platforms/<slug>.yaml`.
...
Options:
  ...
  --tiers PATH          Curated tentpole list (omitted from output if file
                        missing)  [default: catalog/tiers.yaml]
  --help                Show this message and exit.
```
